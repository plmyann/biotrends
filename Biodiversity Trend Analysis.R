...
route.lcrt.proc1$HC <- apply(route.lcrt.proc1[,3:18], 1, function(x) max(abs(x)))

d.tmp <- route.lcrt.proc1 %>% filter(HC >= 5 & HC < 10) %>% mutate(HCIndex5 = 1) 
...
d.tmp <- route.lcrt.proc1 %>% filter(HC >= 10 & HC < 15) %>% mutate(HCIndex10 = 1) 
route.lcrt.proc1 <- merge(route.lcrt.proc1, d.tmp, all.x =T)
...
d.tmp <- route.lcrt.proc1 %>% filter(HC >= 15 & HC < 20) %>% mutate(HCIndex15 = 1) 
route.lcrt.proc1 <- merge(route.lcrt.proc1, d.tmp, all.x =T)
...
d.tmp <- route.lcrt.proc1 %>% filter(HC >= 20 & HC < 25) %>% mutate(HCIndex20 = 1) 
route.lcrt.proc1 <- merge(route.lcrt.proc1, d.tmp, all.x =T)
...
d.tmp <- route.lcrt.proc1 %>% filter(HC >= 25 & HC < 30) %>% mutate(HCIndex25 = 1) 
route.lcrt.proc1 <- merge(route.lcrt.proc1, d.tmp, all.x =T)
...
d.tmp <- route.lcrt.proc1 %>% filter(HC >= 30) %>% mutate(HCIndex30 = 1) 
route.lcrt.proc1 <- merge(route.lcrt.proc1, d.tmp, all.x =T)
